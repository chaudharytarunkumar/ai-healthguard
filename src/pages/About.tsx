...
export default function About() {
 ...
 <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-[2rem] bg-primary shadow-md transform rotate-3">
 <img src={logo} alt="AiHealth Guard" className="h-14 w-14 object-contain brightness-0 invert" />
 </div>
 <h1 className="mb-4 text-5xl font-semibold text-slate-800 sm:text-6xl">About AiHealth Guard</h1>
 <p className="text-lg font-semibold uppercase tracking-[0.3em] text-primary max-w-2xl mx-auto">
 ...
 {/* Project Info */}
 <motion.div variants={itemVariants} className="glass-card rounded-[2.5rem] p-10 shadow-sm border-l-8 border-l-primary flex flex-col h-full">
 <div className="mb-8 flex items-center gap-5">
 <div className="flex h-14 w-14 items-center justify-center rounded-md bg-primary text-white shadow-md">
 <GraduationCap className="h-7 w-7" />
 </div>
 <div>
 <h2 className="font-semibold text-xl">Institutional Basis</h2>
 <p className="text-[10px] font-semibold uppercase text-primary opacity-60">Academic Context</p>
 </div>
 </div>
 ...
 <div>
 <dt className="text-[10px] font-semibold uppercase tracking-[0.2em] text-muted-foreground/60">{k}</dt>
 <dd className="text-sm font-semibold text-slate-800 mt-1">{v}</dd>
 </div>
 </div>
 ))}
 </dl>
 ...
 {/* Team */}
 <motion.div variants={itemVariants} className="glass-card rounded-[2.5rem] p-10 shadow-sm h-full">
 <div className="mb-10 flex items-center gap-5">
 <div className="flex h-14 w-14 items-center justify-center rounded-md bg-primary text-white shadow-md">
 <Users className="h-7 w-7" />
 </div>
 <div>
 <h2 className="font-semibold text-xl">Project Team</h2>
 <p className="text-[10px] font-semibold uppercase text-primary opacity-60">Engineering Core</p>
 </div>
 </div>
 ...
 <div className="flex h-12 w-12 items-center justify-center rounded-md bg-gradient-primary text-sm font-semibold text-white shadow-md group-hover:scale-110 transition-transform">
 {t.name.split("").map((n) => n[0]).join("")}
 </div>
 <div>
 <p className="text-sm font-semibold text-slate-800">{t.name}</p>
 <p className="text-[10px] font-semibold uppercase text-muted-foreground/60 mt-0.5">{t.role}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 {/* References */}
 <motion.div variants={itemVariants} className="mt-10 glass-card rounded-[2.5rem] p-10 shadow-sm">
 <div className="mb-8 flex items-center gap-5">
 <div className="flex h-14 w-14 items-center justify-center rounded-md bg-primary text-white shadow-md">
 <BookOpen className="h-7 w-7" />
 </div>
 <div>
 <h2 className="font-semibold text-xl">Research Backbone</h2>
 <p className="text-[10px] font-semibold uppercase text-primary opacity-60">Clinical Literature</p>
 </div>
 </div>
 <ul className="grid gap-6 sm:grid-cols-2">
 {papers.map((p, i) => (
 <li key={i} className="flex gap-4 p-5 rounded-md bg-muted/10 border-2 border-transparent hover:shadow-sm hover:bg-muted/20 transition-all group">
 ...
 className="mt-12 rounded-[2rem] border-2 border-primary/10 bg-primary/5 p-8 text-center"
 >
 <div className="mx-auto mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-white shadow-md">
 <ShieldCheck className="h-6 w-6" />
 </div>
 <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary mb-4 italic">Safety Protocol &bull; Clinical Disclaimer</p>
