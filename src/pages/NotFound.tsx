...
const NotFound = () => {
 ...
 <h1 className="mb-4 text-7xl md:text-8xl font-semibold text-slate-800">404</h1>
 
 <div className="inline-block mb-6 rounded-full border border-primary/20 bg-primary/5 px-4 py-1 text-xs font-semibold uppercase text-primary">
 ...
 <Button asChild size="lg" className="w-full sm:w-auto h-10 px-4 rounded-md bg-gradient-primary text-white font-semibold shadow-xl transition-all">
 <Link to="/" className="gap-2">
 <Home className="h-5 w-5" /> Main Dashboard
 </Link>
 </Button>
 <Button asChild variant="outline" size="lg" className="w-full sm:w-auto h-10 px-4 rounded-md border-2 font-semibold shadow-sm hover:bg-muted transition-all">
